...
\todo{Geography rarely if ever used LDA as a classifier.  LDA is useful irregular data due to examinign it's latent semantic properties.  LDA did show that VC capital comes at the expense of institutional investment in securities, something that not explicit in the literature.  It's hinted at \cite{bottspension1987}}
