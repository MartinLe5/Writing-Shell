...
\usepackage{footmisc}
\usepackage{natbib}
\usepackage[intoc, tocbasic]{nomencl}
\makenomenclature
\usepackage[super]{nth}
\usepackage{subcaption}
\hyphenation{app-ren-tis-sage}
\graphicspath{{images/}}
\renewcommand\footnotelayout{\fontsize{10}{12}\selectfont}
\usepackage[left=40.00mm, right=25.00mm, top=25.00mm, bottom=25.00mm]{geometry}\usepackage{appendix}
...
\newcommand{\examo}{Dr. Diana Mok}  %examining committee (up to four, if less leave blank)
...
\newcommand{\spinetitle}{Institutional Investment in the USA from 1999 to 2018}%only if the above is more than 60 characters
...
%\newcommand{\listappendixname}{List of Appendices}
%\newlistof{myappendices}{app}{\listappendixname}
%\newcommand{\myappendices}[1]{\addcontentsline{app}{myappendices}{#1}\par}
\addcontentsline{toc}{chapter}{List of Appendices}
\begin{appendices}
